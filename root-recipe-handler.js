// Root level recipe-handler.js
// This file should be created in the ROOT of the Lambda function (not in handlers folder)

exports.generateRecipe = async (event, context) => {
    console.log('Recipe handler started - ROOT LEVEL');
